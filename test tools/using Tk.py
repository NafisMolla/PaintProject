...
draw.rect(screen,(0,255,0),colourRect,2)
drawcolor = (0,0,0)
...
while running:
    ...
    if click:
        if openRect.collidepoint(mx,my):
            ...
            drawcolor, drawcolorAsString = askcolor(title='pick your colour, not your nose.') ###
            #print(ctuple, drawcolor)
        else:
            draw.circle(screen,drawcolor,(mx,my),20)
    display.flip()
